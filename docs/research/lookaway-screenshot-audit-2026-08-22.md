...
| [`05-screen-breaks-bottom.png`](reference-screenshots/lookaway-cleanshot-2026-08-22/05-screen-breaks-bottom.png) | Casual/Balanced/Hardcore enforcement, snooze budget, escape behavior, early ending, automatic lock | Existing Gentle/Balanced/Focused policy covers the central idea. Automatic lock is opt-in only and deferred. |
