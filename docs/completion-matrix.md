...
| Automated tests and QML review | Partial | 28 model tests, manifest validation, system qmllint, six-pass semantic review, live flow proof, and keyboard acceptance evidence exist; release acceptance matrix remains |
