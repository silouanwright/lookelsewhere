...
| Optional Steam game pause | Implemented; live game recheck required | Sundown's root-owned status provides process-level Steam/Proton activity without duplicating its scanner; accounting pauses without treating gameplay as away time, while focused-window protection remains the standalone fallback |
